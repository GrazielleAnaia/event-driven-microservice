package com.grazielleanaia.withdrawalms.handler;
...
public class WithdrawalRequestedEventHandler {
    ...
    @KafkaHandler
    public void handle(@Payload WithdrawalRequestedEvent withdrawalEvent) {
        LOGGER.info("Received new withdrawal event: {} ", withdrawalEvent.getAmount());
    }
}
